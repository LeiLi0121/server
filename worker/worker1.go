...
func (w *Worker) Worker(req gol.HaloReq, res *gol.HaloRes) (err error) {
	...
	if req.WorldPart != nil {
		...
		res.WorldPart = initWorld(req.PartHeight, req.Width)
		//res.WorldPart = initWorld(req.PartHeight, req.Width)
		//res.WorldPart = make([][]uint8, req.PartHeight)
		//for p := range res.WorldPart {
		//	res.WorldPart[p] = make([]uint8, req.Width)
		//}
		...
		//res.WorldPart = calculateNextState(1, req.PartHeight, temp)
